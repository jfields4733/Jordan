...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/ENES246/13Debounce_Shift/3_reUseableDeBounce/deBounce.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debounceTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source debounceTest.tcl
