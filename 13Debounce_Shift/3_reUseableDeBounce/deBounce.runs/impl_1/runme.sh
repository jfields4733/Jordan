...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/ENES246/13Debounce_Shift/3_reUseableDeBounce/deBounce.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log debounceTest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source debounceTest.tcl -notrace
