...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/ENES246/13Debounce_Shift/4_UniversalShiftRegister/project2/cliff_classic/cliff_classic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cliff_classic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cliff_classic.tcl -notrace
