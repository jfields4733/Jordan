...
HD_PWD='C:/Users/SET253-11U/Documents/GitHub/Jordan-s-ENES246/13Debounce_Shift/2_deBounceFz/debouncefz.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log def_name.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source def_name.tcl -notrace
