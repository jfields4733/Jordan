...
HD_PWD='C:/Users/SET253-17U.HCCMAIN/Documents/GitHub/ENES246/17DataCircuitManualMultiply/rtlMultiply/multiply4bits/multiply4bits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul4bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul4bits.tcl
