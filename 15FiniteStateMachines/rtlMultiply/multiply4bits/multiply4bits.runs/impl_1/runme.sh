...
HD_PWD='C:/Users/SET253-17U.HCCMAIN/Documents/GitHub/ENES246/17DataCircuitManualMultiply/rtlMultiply/multiply4bits/multiply4bits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mul4bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mul4bits.tcl -notrace
