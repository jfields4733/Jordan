...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/ENES246/11IP/4_ShiftOperator/ShiftOperator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shiftOperator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shiftOperator.tcl -notrace
