...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/ENES246/11IP/4_ShiftOperator/ShiftOperator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shiftOperator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shiftOperator.tcl
