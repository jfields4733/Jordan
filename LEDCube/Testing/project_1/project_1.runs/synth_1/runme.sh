...
HD_PWD='C:/Users/SET253-04U.HCCMAIN/Documents/GitHub/Jordan-s-ENES246/LEDCube/Testing/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log latch_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source latch_test.tcl
