...
HD_PWD='C:/Users/SET253-04U.HCCMAIN/LEDCube6/LEDCube6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eightPlanes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eightPlanes.tcl -notrace
