...
HD_PWD='C:/Users/SET253-04U.HCCMAIN/Documents/GitHub/Jordan-s-ENES246/LEDCube/LEDCube6/LEDCube6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eightPlanes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eightPlanes.tcl
