...
HD_PWD='C:/Users/SET253-05U.HCCMAIN/Desktop/Lab8-Clocks_Rings/vivado/clocked4x7SegDisplay/clocked4x7SegDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clocked4x7SegDisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clocked4x7SegDisplay.tcl
