...
HD_PWD='C:/Users/SET253-05U.HCCMAIN/Desktop/Lab8-Clocks_Rings/vivado/clocked4x7SegDisplay/clocked4x7SegDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clocked4x7SegDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clocked4x7SegDisplay.tcl -notrace
