...
HD_PWD='C:/Users/SET253-04U.HCCMAIN/Documents/GitHub/Jordan-s-ENES246/14Rings/2_Mod/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log posedge2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source posedge2.tcl
