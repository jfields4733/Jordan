...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/ENES246/-8SevenSegDisplays/6_7SegDoubleBlanking/7segSplit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log split16to32Display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source split16to32Display.tcl -notrace
