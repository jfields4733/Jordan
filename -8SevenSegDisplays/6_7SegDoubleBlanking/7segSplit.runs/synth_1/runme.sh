...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/ENES246/-8SevenSegDisplays/6_7SegDoubleBlanking/7segSplit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log split16to32Display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source split16to32Display.tcl
